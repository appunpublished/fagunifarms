...
function initGame() {
  ...
  if (currentLevel === 0) {
    ...
    const shapeDefs = [
      ...
      { // 14: Boat
        color: "#007AFF",
        pts: [[-0.6, 0.2], [-0.4, 0.6], [0.4, 0.6], [0.8, 0.2], [0.1, 0.2], [0.6, -0.2], [0, -0.8], [-0.6, -0.2]]
      },
      { // 15: Rocket
        color: "#FF3B30",
        pts: [[0, -0.8], [0.3, -0.2], [0.3, 0.5], [0.6, 0.8], [0.3, 0.8], [0.1, 0.6], [-0.1, 0.6], [-0.3, 0.8], [-0.6, 0.8], [-0.3, 0.5], [-0.3, -0.2]]
      },
      { // 16: Butterfly
        color: "#AF52DE",
        pts: [[0, -0.5], [0.1, -0.2], [0.7, -0.6], [0.9, -0.1], [0.5, 0.2], [0.8, 0.7], [0.3, 0.8], [0.1, 0.3], [0, 0.6], [-0.1, 0.3], [-0.3, 0.8], [-0.8, 0.7], [-0.5, 0.2], [-0.9, -0.1], [-0.7, -0.6], [-0.1, -0.2]]
      },
      { // 17: Diamond
        color: "#5AC8FA",
        pts: [[0, -0.8], [0.6, 0], [0, 0.8], [-0.6, 0]]
      },
      { // 18: Lightning Bolt
        color: "#FFD500",
        pts: [[0.2, -0.8], [-0.5, 0.1], [-0.1, 0.1], [-0.3, 0.8], [0.5, -0.2], [0.1, -0.2]]
      },
      { // 19: Umbrella
        color: "#FF2D55",
        pts: [[-0.8, 0], [-0.4, -0.6], [0, -0.8], [0.4, -0.6], [0.8, 0], [0.4, -0.1], [0.1, -0.1], [0.1, 0.6], [-0.2, 0.8], [-0.4, 0.5], [-0.1, 0.5], [-0.1, -0.1], [-0.4, -0.1]]
      }
    ];
